...
class teacher implements Serializable 
	...
	{
		String Employee_ID, Name, Subject, Department;
...
public class Six extends Frame implements ActionListener{
	 		...
	 		{		
	 				...
	 				h.put(Employee_id,t1);
	 				  ...
	 				  try {
            				...
            				FileOutputStream fileOut = new FileOutputStream("assets/file.ser");
    	...
    	if(e.getSource()==b2)
{
  ...
  FileInputStream fileIn = new FileInputStream("assets/file.ser");
